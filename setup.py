...
def update_version_py():
    ...
    f = open("graphembed/_version.py", "w")
    f.write(VERSION_PY % ver)
    f.close()
    print("set graphembed/_version.py to '%s'" % ver)


def get_version():
    try:
        f = open("graphembed/_version.py")
    except EnvironmentError:
        return None
...
setup(
    ...
    entry_points = { 'console_scripts': ['graphembed=graphembed.graph_embed:main'] },
